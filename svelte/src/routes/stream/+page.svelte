<script>
    ...
    let title = "ChatGPT Simple w/Stream"
    ...
    let system_prompt = "あなたはAIアシスタントです。"
    let message = "";
    ...
    async function postMessage() {
      ...
      const send_chats = [{"role":"system","content":system_prompt},...chats.slice(-10)]
...
<div class="main">
  ...
  <div class="board">
    <div class="system_field">
      <h3>ChatGPT への基本指示</h3>
      <textarea class="systembox" title="system" name="system" id="system" placeholder="ChatGPTへの基本指示" bind:value={system_prompt}></textarea>
    </div>
